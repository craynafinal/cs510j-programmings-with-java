...
public class AppointmentBookService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["edu.pdx.cs410J.jsl.client.Appointment/1615085406"] = [
        @edu.pdx.cs410J.jsl.client.Appointment_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.jsl.client.Appointment_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Ledu/pdx/cs410J/jsl/client/Appointment;),
      ];
    
    result["edu.pdx.cs410J.jsl.client.AppointmentBook/2572655170"] = [
        @edu.pdx.cs410J.jsl.client.AppointmentBook_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.jsl.client.AppointmentBook_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Ledu/pdx/cs410J/jsl/client/AppointmentBook;),
      ];
    
    result["[Ledu.pdx.cs410J.jsl.client.Appointment;/2104461639"] = [
        @edu.pdx.cs410J.jsl.client.Appointment_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @edu.pdx.cs410J.jsl.client.Appointment_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Ledu/pdx/cs410J/jsl/client/Appointment;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.jsl.client.Appointment::class)] = "edu.pdx.cs410J.jsl.client.Appointment/1615085406";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.jsl.client.AppointmentBook::class)] = "edu.pdx.cs410J.jsl.client.AppointmentBook/2572655170";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@edu.pdx.cs410J.jsl.client.Appointment[]::class)] = "[Ledu.pdx.cs410J.jsl.client.Appointment;/2104461639";
